...
export const headerData = {
	albumInfo: {
		title: 'Хиты',
		description: 'Как талантливый музыкант находит свой уникальный ритм, так и ты обязательно добьешься высот в управлении. Формула успеха довольно проста! Определи ключевые приоритеты, постепенно расширяй свои компетенции, и не заметишь, как достигнешь впечатляющих результатов.',
	},
	navigation: [
		{
			title: 'О проекте',
