			...
			<div class="row">
				...
				<div class="col-lg-8 col-xs-12">
					<p class="text text-l text-center text-xs-left text-gray-1">
						...
						задачами. -->
						Руководители каждого уровня управления имеют свой фокус внимания. Прежде чем мы&nbsp;углубимся
			...
			<checkbox-question :answers-grid="checkboxQuestionTrack2.answersGrid"
				...
				<template v-slot:question-text="">
					<h4 class="mb-rem-1-50 mb-xs-rem-1-0">
						На&nbsp;чем сконцентрировано твое внимание сейчас? Какие области управления для тебя наиболее
						важные?
					</h4>
					...
					<div class="row js-scroll-element"
						...
						<div class="col-lg-8 col-xs-12">
							<div class="card card_medium card_white">
								...
								<p class="text text-l">
									Каждый уровень менеджмента имеет свою ключевую область ответственности. Начинающие
									руководители часто пытаются охватить все сферы, что приводит к&nbsp;быстрому
									выгоранию. Сейчас мы&nbsp;разберем основные зоны ответственности для каждого уровня
									управления.
								</p>
							</div>
						</div>
						...
						<div class="col-lg-8 col-xs-12">
							<div class="card card_medium card_white">
								...
								<p class="text text-l">Конечно, руководителям нужно обращать внимание на&nbsp;все
									области
									управления, но&nbsp;для каждого есть одна ключевая. Начинающие руководители часто
					...
					<div class="col-lg-8 col-xs-12">
						<div class="card card_medium card_white">
							...
							<p class="text text-l">Помни: попытка охватить все уровни управления может снизить
								эффективность.
								Сделать все самому&nbsp;&mdash; это неверный путь. Поэтому сфокусируйся на&nbsp;своей
								ключевой
				...
				<div class="track-recap js-track-recap mb-rem-7-75">
					...
					<div class="track-recap__container js-track-recap-container">
						...
						<div class="track-recap__text-wrapper">
							...
							<div class="track-recap__text js-track-recap-text">
								<h3 class="text-white text-xs-center w-100">Линейные менеджеры и&nbsp;менеджеры среднего
									звена
