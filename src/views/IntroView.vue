									...
									<div class="row h-100">
										...
										<div class="col-lg-8 col-xs-12">
											<div class="card card_gray h-100">
												...
												<p class="text text-m mb-rem-2-0 mb-xs-rem-1-50">Каждый трек
													представляет
													собой тему
										...
										<div class="col-lg-8 col-xs-12">
											<div class="card card_gray h-100">
												...
												<p class="text text-m">Дополнительные материалы&nbsp;&mdash; это
													коллекция
													статей, подобранных специально под определенный трек. Погрузись
													глубже
													в&nbsp;тему
													и&nbsp;открой для себя новые грани управления. Найти материалы
													можно:
												</p>
