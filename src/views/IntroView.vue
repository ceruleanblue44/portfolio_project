							...
							<div class="row">
								<div class="col-lg-8 col-xs-12">
									<div class="card card_medium card_gray">
										...
										<p class="text text-l">Сейчас мы&nbsp;настраиваемся на&nbsp;музыкальную волну и&nbsp;											отправляемся в&nbsp;путешествие по&nbsp;музыкальным жанрам.
										</p>
									</div>
								</div>
								...
								<div class="row h-100">
									...
									<div class="col-lg-8 col-xs-12">
										<div class="card card_gray h-100">
											...
											<p class="text text-m mb-rem-2-0 mb-xs-rem-0-75">Каждый трек представляет
												собой тему
